...
@Entity
@Table(name = "log_movimentacao_V2")
public class LogMovimentacaoJpaEntity {
    @Id
    ...
    // Construtores
    public LogMovimentacaoJpaEntity() {}

    public LogMovimentacaoJpaEntity(Long id, Long movimentacaoId, LocalDateTime dataMovimentacao,

...
@Service
public class BuscarLogsPorPeriodoService implements BuscarLogsPorPeriodoUseCase {

    private final LogMovimentacaoPort logMovimentacaoPort;

    public BuscarLogsPorPeriodoService(LogMovimentacaoPort logMovimentacaoPort) {
        this.logMovimentacaoPort = logMovimentacaoPort;
    }

    @Override
    public List<LogMovimentacaoOutput> executar(LocalDateTime inicio, LocalDateTime fim) {
        List<LogMovimentacao> logs = logMovimentacaoPort.buscarPorPeriodo(inicio, fim);
